...
class MyNode(Node):
    ...
    def __init__(self):
        ...
        self.publisher_ = self.create_publisher(LaserScan,"/burger_1/scan", 10)
        self.publisher_odom = self.create_publisher(Odometry,"/burger_1/odom", 10)
        self.beagle_path_publisher = self.create_publisher(Path,"/burger_1/moved_path",10)
        self.subscriber_ = self.create_subscription(Twist,"/burger_1/cmd_vel",self.subscriber_callback,10)
        ...
        self.beagle_moved_path.header.frame_id = "/burger_1/odom"
    ...
    def publish_lidar(self):
        ...
        msg = LaserScan()
        msg.header.frame_id = 'burger_1/base_link'
    ...
    def publish_odom(self):
        self.odom.header.frame_id = 'burger_1/odom'
        self.odom.header.stamp = self.get_clock().now().to_msg()
        self.odom.child_frame_id = 'burger_1/base_scan'
    ...
    def tf_publisher(self):
        ...
        map_to_odom.child_frame_id = 'burger_1/odom'
        ...
        odom_to_base_link.header.frame_id = 'burger_1/odom'
        odom_to_base_link.child_frame_id = 'burger_1/base_link'
        ...
        base_footprint_to_base_link.header.frame_id = 'burger_1/base_link'
        base_footprint_to_base_link.child_frame_id = 'burger_1/base_footprint'
        ...
        base_link_to_left_wheel.header.frame_id = 'burger_1/base_link'
        base_link_to_left_wheel.child_frame_id = 'burger_1/left_wheel'
        ...
        base_link_to_right_wheel.header.frame_id = 'burger_1/base_link'
        base_link_to_right_wheel.child_frame_id = 'burger_1/right_wheel'
        ...
        base_link_to_chassis.header.frame_id = 'burger_1/base_link'
        base_link_to_chassis.child_frame_id = 'burger_1/chassis'
        ...
        chassis_to_base_scan.header.frame_id = 'burger_1/chassis'
        chassis_to_base_scan.child_frame_id = 'burger_1/base_scan'
