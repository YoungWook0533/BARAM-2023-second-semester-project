...
class MyNode(Node):
    ...
    def __init__(self):
        ...
        self.gole_pose_subscriber_ = self.create_subscription(PoseStamped, "/burger_1/goal_pose", self.astar_planner,10)
        self.pubscribe_odometry = self.create_subscription(Odometry,"/burger_1/odom",self.odometry_callback,10)
        self.path_publisher_ = self.create_publisher(Path,"/burger_1/global_path",10)
